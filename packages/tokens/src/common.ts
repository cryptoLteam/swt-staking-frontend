...
export const GBLOCK_BSC = new Token(
  ChainId.BSC,
  '0x43b687c6F2f2cAAcab5E9604e37Ac662954BAC4c',
  18,
  'GBLOCK',
  'GameBlock Token',
  'https://gameblock.link/',
)

export const GBLOCK_GOERLI = new Token(
  ChainId.GOERLI,
  '0xFECe95762Da5738914957C7c15c33Bd107B94767',
  18,
  'GBLOCK',
  'GameBlock Token',
  'https://gameblock.link/',
...
export const GBLOCK_ETHEREUM = new Token(
  ChainId.ETHEREUM,
  '0x1f05DeE43dF9fd0Cd7F4b011B20b04870a30c29A',
  18,
  'SWT',
  'ShibWallet',
  'https://www.shibwallet.app/',
)
...
export const USDT_GOERLI = new Token(
  ChainId.GOERLI,
  '0x5858f25cc225525A7494f76d90A6549749b3030B',
  6,
  'USDT',
  'test USDT',
)
...
export const GBLOCK = {
  [ChainId.BSC]: GBLOCK_BSC,
  [ChainId.GOERLI]: GBLOCK_GOERLI,
  [ChainId.ETHEREUM]: GBLOCK_ETHEREUM
}