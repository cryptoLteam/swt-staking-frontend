...
// Buy Flow:
// Shown if user wants to pay with GBLOCK and contract isn't approved yet
// Sell Flow:
        ...
        <Flex flexDirection="column">
          ...
          {!isApproved && (
            <Text mt="8px" maxWidth="275px" small color="textSubtle">
              {variant === 'buy' && t('Please enable GBLOCK spending in your wallet.')}
              {variant === 'sell' && t('Please enable your NFT to be sent to the market.')}

              {variant === 'Mint' && t('Please enable GBLOCK sending in your wallet.')}
